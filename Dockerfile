...
# COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/kraken_streamer ./
COPY --from=builder /app/_build/prod/rel/kraken_streamer ./
...
# CMD ["/app/bin/server"]
CMD ["/app/bin/kraken_streamer", "start"]
